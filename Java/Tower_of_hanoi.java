...
class Tower_functions extends Tower {
    ...
    public static void put() {
        ...
        switch (Temp_Tower) {
            case 1 -> Tower1()[Temp_Element] = Tower1()[Disk_Input-1];
            case 2 -> Tower1()[Temp_Element] = Tower2()[Disk_Input-1];
            case 3 -> Tower1()[Temp_Element] = Tower3()[Disk_Input-1];
        }
    }
}
